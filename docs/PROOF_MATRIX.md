...
| PM-10 | Meta-transition requires refinement proof | `core/meta_transition.py::RefinementProof` + `MetaTransition` | PARTIAL→NEAR-COMPLETE | T24–T29 | Connect proof object to canonical evolution/admission path and formalize stronger refinement obligations |
