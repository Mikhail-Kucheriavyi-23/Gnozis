...
| PM-05 | Apply cannot bypass Admission | `core/admission.py`; canonical evolutionary Ψ path; legacy State engine isolated | PARTIAL→NEAR-COMPLETE (scoped) | T41 | Adversarial tests added; universal ΨTransition non-bypass remains unproven |
