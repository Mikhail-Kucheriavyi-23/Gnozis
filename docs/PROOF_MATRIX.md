...
| PM-07 | Partial-order/branch outcome allowed | `Branch` lineage + branch-aware `Conflict` preserve provenance | PARTIAL→NEAR-COMPLETE | T18–T23 | Define deferred/parallel admissible outcome semantics |
