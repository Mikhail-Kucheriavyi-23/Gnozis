...
| PM-07 | Partial-order/branch outcome allowed | `core/branch.py` adds branch identity, parent lineage, depth, and incomparability | PARTIAL | T18–T23 | Integrate branch identity into Merge/Resolution and define admissible deferred outcomes |
