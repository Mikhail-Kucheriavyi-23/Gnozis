...
| PM-07 | Partial-order/branch outcome allowed | `Branch` lineage + explicit `DeferredConflict` preserve concurrent branches without forced selection | NEAR-COMPLETE | T18–T23 | Formalize parallel outcome relation/merge semantics |
